...
public class AdvertController {
	...
	@GetMapping(value= "users/{userId}/favourite-advert")
	public ResponseEntity<Set<AdvertResponse>> getFavouriteAdvertsOfUser(@PathVariable(required = false) Long userId) {
		return new ResponseEntity<>(userService.getFavouriteAdvertsOfUser(userId), HttpStatus.OK);
	}
